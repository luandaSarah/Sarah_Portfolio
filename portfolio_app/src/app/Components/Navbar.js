...
export default function Navbar() {
  return (
    <nav className=" lg:pb-4 col-start-1 fixed bottom-0 z-30  w-full h-40 lg:h-full flex items-end justify-center  lg:z-0 lg:static   col-end-11  row-start-8 row-end-9 lg:col-start-1 lg:col-end-3 lg:row-start-2 lg:row-end-8  text-xl">
