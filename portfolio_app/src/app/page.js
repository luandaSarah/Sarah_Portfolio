    ...
    return (
      <>
        <div className="presentation-container  flex flex-col items-center">
          ...
          <p className="text-blackColor text-center text-lg pt-2 mt-9">
        ...
        <div className="hardSkills-container flex justify-around mt-12">
          <div className="backSkills">
            <h3 className="text-lg text-center mb-4 text-blackColor semibold">Back-End</h3>
            <ul className="skillsList  grid grid-cols-3 gap-3">
              <li className="hardSkills-Bubble text-center bg-blackColor text-whiteColor px-2 rounded-2xl">
                PHP
              </li>
              <li className="hardSkills-Bubble text-center bg-blackColor text-whiteColor px-2 rounded-2xl">
                SYMPHONY
